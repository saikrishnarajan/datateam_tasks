...
BEGIN
INSERT INTO [T_JobOpen]([CompanyId] ,[JobId] ,[FromDate],[ToDate]) VALUES
(6794,3306178, CAST('2016-09-08' AS Datetime), CAST('2016-09-18' AS Datetime))
End

IF NOT EXISTS (SELECT PkId from T_JobOpen(nolock) where CompanyId=6794 and JobId= 3306179 )
BEGIN
INSERT INTO [T_JobOpen]([CompanyId] ,[JobId] ,[FromDate],[ToDate]) VALUES
(6794,3306179, CAST('2016-01-02' AS Datetime), CAST('2016-03-12' AS Datetime))
End
...
BEGIN
INSERT INTO [T_JobOpen]([CompanyId] ,[JobId] ,[FromDate],[ToDate]) VALUES
(6794,3306185, CAST('2017-10-08' AS Datetime), CAST('2017-09-19' AS Datetime))
End
...
BEGIN
INSERT INTO [T_JobOpen]([CompanyId] ,[JobId] ,[FromDate],[ToDate]) VALUES
(6794,3306177, CAST('2015-01-12' AS Datetime),NULL)
End
...
BEGIN
INSERT INTO [T_JobOpen]([CompanyId] ,[JobId] ,[FromDate],[ToDate]) VALUES
(6794,3306181, CAST('2015-06-11' AS Datetime),NULL)
End
